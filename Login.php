...
<header>
  ...
  <div class="topnav-centered">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <a class="nav-link" href="https://www.holyghostprep.org/calendar">Calendar</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="https://ehgp.holyghostprep.org/announcements.php">Announcements</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="https://ehgp.holyghostprep.org/BellSchedules.pdf">Bell Schedules</a>
          </li>
      </ul>
    </div>
  </nav>
